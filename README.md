...
### Credentials to use:
- Alternatively you can go to swagger using the following link  <a href= "https://asecmpg323-project-2-34292748.azurewebsites.net/swagger/index.html">SwaggerUI</a></li>
